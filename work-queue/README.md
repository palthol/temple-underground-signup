...
| [API-GATE-001](tasks/API-GATE-001.md) | validation | ready | API-DEV-001, API-TEST-001, API-TEST-002, API-OPS-001 | Define safe non-production validation environment |
